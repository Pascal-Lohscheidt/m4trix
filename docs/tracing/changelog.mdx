...
<Update label="June 3, 2026" description="Unreleased · latest tracing v0.9.2" tags={["Features"]} rss={{ title: "June 3, 2026 — @m4trix/tracing updates", description: "add toM4trixTracer adapter for matrix NetworkTracer" }}>
...
- add toM4trixTracer adapter for matrix NetworkTracer (`tracing`) ([e6728d0](https://github.com/Pascal-Lohscheidt/m4trix/commit/e6728d0bb098a36e779fd885787289a8bacc60da))
  ...
  - Bridge Tracer to core NetworkTracer for runs, agent invokes, and child spans
  - Persist AgentNetwork lifecycle into TraceStore (same pipeline as LangChain traces)
  - Export toM4trixTracer; optional @m4trix/core peer dependency for the adapter

</Update>

<Update label="May 28, 2026" description="trace-viewer v0.14.1 · tracing v0.9.2" tags={["Fixes"]} rss={{ title: "May 28, 2026 — @m4trix/tracing updates", description: "trpc version bump; trpc version bump; trpc version bump" }}>
