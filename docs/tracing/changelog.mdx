...
<Update label="May 15, 2026" description="v0.14.0" tags={["Features"]} rss={{ title: "May 15, 2026 — @m4trix/tracing updates", description: "added cost esitamte; improved token display for langgraph" }}>
...
<Update label="May 14, 2026" description="v0.14.0" tags={["Features","Improvements"]} rss={{ title: "May 14, 2026 — @m4trix/tracing updates", description: "added adapter to offer different tracer shapes; added adapter to offer different tracer shapes; code cleanup" }}>
...
<Update label="May 9, 2026" description="v0.14.0" tags={["Features","Fixes"]} rss={{ title: "May 9, 2026 — @m4trix/tracing updates", description: "new filter options; new layout improvements; fixed package setup" }}>
...
<Update label="May 8, 2026" description="trace-viewer v0.14.0 · tracing v0.9.1" tags={["Features"]} rss={{ title: "May 8, 2026 — @m4trix/tracing updates", description: "bundle, design and setup improvement; first version of trace viewer; first version of tracing" }}>
...
<Update label="April 18, 2026" description="tracing v0.9.1 · trace-viewer v0.14.0" tags={["Improvements"]} rss={{ title: "April 18, 2026 — @m4trix/tracing updates", description: "update import paths to use .js extensions for consistency" }}>
...
<Update label="February 18, 2026" description="v0.9.1" tags={["Features"]} rss={{ title: "February 18, 2026 — @m4trix/tracing updates", description: "introduction of tracing" }}>
