...
_Last regenerated 2026-06-05 (UTC)._

<Update label="May 28, 2026" description="Unreleased · latest evals v0.34.2" tags={["Fixes"]} rss={{ title: "May 28, 2026 — @m4trix/evals updates", description: "upgrade dependencies to clear high-severity audit findings" }}>

### Bug fixes

- upgrade dependencies to clear high-severity audit findings (`evals`) ([3316b84](https://github.com/Pascal-Lohscheidt/m4trix/commit/3316b84971ab10b6c8bbe733b34a1bbaad8946c5))
...
<Update label="April 18, 2026" description="v0.34.1" tags={["Features","Fixes","Improvements"]} rss={{ title: "April 18, 2026 — @m4trix/evals updates", description: "datasets now accept top level and filter; update import paths to use .js extensions for consistency; update import paths to use .js extensions for consistency" }}>
...
<Update label="April 9, 2026" description="v0.33.0" tags={["Features"]} rss={{ title: "April 9, 2026 — @m4trix/evals updates", description: "introduced sampling" }}>
...
<Update label="March 27, 2026" description="v0.32.0" tags={["Features"]} rss={{ title: "March 27, 2026 — @m4trix/evals updates", description: "introduced grouped test case export" }}>
...
<Update label="March 22, 2026" description="v0.31.0" tags={["Features"]} rss={{ title: "March 22, 2026 — @m4trix/evals updates", description: "introduced triggeredAt; introduced trigger timestamp" }}>
...
<Update label="March 20, 2026" description="v0.29.0" tags={["Features"]} rss={{ title: "March 20, 2026 — @m4trix/evals updates", description: "introduced test case name in meta; introduced experiment name; adjustment of dataset and test case naming" }}>
...
<Update label="March 7, 2026" description="v0.25.0" tags={["Features"]} rss={{ title: "March 7, 2026 — @m4trix/evals updates", description: "new features and project restructure" }}>
...
<Update label="February 26, 2026" description="v0.23.0" tags={["Features","Fixes"]} rss={{ title: "February 26, 2026 — @m4trix/evals updates", description: "removed cpu concurrency defintion; improved concurrency for evals; replaced the json diff package due to invalid package hashes" }}>
...
<Update label="February 21, 2026" description="v0.16.0" tags={["Features"]} rss={{ title: "February 21, 2026 — @m4trix/evals updates", description: "integrate json-diff for enhanced diff logging and evaluation; enhance RunDetailsView and RunView for better score and metric display; update dependencies and enhance CLI functionality" }}>
...
<Update label="February 20, 2026" description="v0.13.0" tags={["Features"]} rss={{ title: "February 20, 2026 — @m4trix/evals updates", description: "enhance test case handling with reruns and aggregation support; improved cli; improved cli" }}>
...
<Update label="February 19, 2026" description="v0.10.0" tags={["Features"]} rss={{ title: "February 19, 2026 — @m4trix/evals updates", description: "improved cli; added diffing" }}>
...
<Update label="February 18, 2026" description="v0.8.0" tags={["Features"]} rss={{ title: "February 18, 2026 — @m4trix/evals updates", description: "update version to 0.7.0, add output handling in evaluator, and enhance test case structure (#27); first version (#26)" }}>
