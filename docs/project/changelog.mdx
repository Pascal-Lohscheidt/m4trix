...
<Update label="June 5, 2026" description="Unreleased · latest core v0.16.1, stream v0.8.2, react v0.8.2, ui v0.8.2" tags={["Features"]} rss={{ title: "June 5, 2026 — @m4trix/core updates", description: "replace channel sinks with proxy consumers" }}>
...
<Update label="June 3, 2026" description="Unreleased · latest core v0.16.1, stream v0.8.2, react v0.8.2, ui v0.8.2" tags={["Features"]} rss={{ title: "June 3, 2026 — @m4trix/core updates", description: "add dependency layers, typed tools, and network tracing" }}>
...
<Update label="May 28, 2026" description="Unreleased · latest core v0.16.1, stream v0.8.2, react v0.8.2, ui v0.8.2" tags={["Fixes"]} rss={{ title: "May 28, 2026 — @m4trix/core updates", description: "upgrade dependencies to clear high-severity audit findings" }}>
