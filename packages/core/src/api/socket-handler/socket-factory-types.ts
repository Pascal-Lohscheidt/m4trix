 ...
 */
export type SetupSocketHandlersParams<SocketType, Extra = Record<string, never>> = Omit<
  Extra,
  keyof BaseSetupSocketHandlersParams<SocketType>
> &
 ...
 */
export type SocketFactoryAdapter<SocketType, T extends Partial<Hooks<SocketType>>> = (
  hooks: T,
) => void;
